...
export const PRODUCTS: Product[] = [
  ...
  },
  {
      ...
      "helps": "Price tells you where the market went – DS Iceberg marks where a large participant would not let it go. Confirmed levels become clean runway zones you can lean on, and the ones an independent volume footprint also confirms are flagged separately, so the levels with the most confirmation are obvious at a glance.",
