/**
 * Terms & Conditions — ported word for word from the previous site's
 * TermsModal.tsx (last updated 08/09/2026, New York-governed), with §1 and §4
 * made lineup-agnostic while the collection is reworked. Re-list the
 * components in §1 and the marks in §4 when the catalogue returns.
 *
 * NOT LEGAL ADVICE: drafted without an attorney as a baseline. Have counsel
 * review; if a legal entity is registered, insert its name in the Preamble and §4.
 */
const SUPPORT_EMAIL = "support@dsuniverse.net";
export const TERMS_LAST_UPDATED = "08/09/2026";
...
export const SECTIONS: Section[] = [
  {
    ...
    blocks: [
      ...
      {
        ul: [
          "Individual indicators and overlays — each named and described at the point of sale.",
          "Packs and membership tiers — bundles of the above components, as described at the point of sale. A bundle grants access to exactly the components it lists and to nothing else.",
          "Documentation — the README and reference material supplied with each component, provided at no additional charge.",
        ],
      },
      {
  ...
  },
  {
    ...
    blocks: [
      ...
      { p: "These restrictions apply equally to any component made available at no charge." },
    ],
  },
  {
    ...
    blocks: [
      {
        p: 'All intellectual property rights in the Software — including source code, compiled code, methodologies, scoring engines, visual designs, panel layouts, naming, documentation, branding, and the "DS Universe" mark and the name of every individual component — are and remain the exclusive property of the Provider. These Terms do not transfer any ownership rights to you, whether you obtain paid or free components.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        p: "OUR TOTAL AGGREGATE LIABILITY FOR ANY AND ALL CLAIMS ARISING OUT OF OR RELATED TO THE SOFTWARE OR THESE TERMS SHALL NOT EXCEED THE TOTAL AMOUNT YOU ACTUALLY PAID FOR THE SOFTWARE. For any component made available at no charge, for which no fee is paid, our aggregate liability shall not exceed USD $0.",
      },
      {
  ...
  },
  {
    ...
    blocks: [
      {
        ul: [
          "Purchase options. Components, packs, and tiers may be offered as a one-time purchase granting a lifetime license, as a recurring membership, or as both. The option you selected, its price, and its billing interval are those shown at the point of sale, payable in USD.",
          "Memberships. Where you obtain access through a recurring membership, your right to use the Software continues for as long as that membership remains active and paid. If the membership lapses, is cancelled, or is refunded, access to the components granted by it ends. Cancellation takes effect at the end of the paid period unless stated otherwise at the point of sale.",
          "Lifetime scope. Where you obtain a lifetime license, it entitles you to continued use of the components you obtained for the operational lifetime of the Provider. It does not entitle you to any specific future component, feature, or platform-compatibility guarantee unless that entitlement was expressly stated at the point of sale.",
  ...
  },
  {
    ...
    blocks: [
      {
        p: "All sales are final and non-refundable. Because the Software is delivered digitally and can be copied upon delivery, no refunds, exchanges, or credits are provided once download access, license keys, or files have been issued, except where a refund is required by applicable law. By completing your purchase, you expressly acknowledge and consent to this policy. Any component made available at no charge is likewise non-refundable. Where a recurring membership is cancelled, no partial refund is issued for the remainder of the paid period unless required by applicable law.",
      },
    ],
  },
  {
